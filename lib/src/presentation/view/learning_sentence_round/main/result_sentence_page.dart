...
import 'package:qlish/src/presentation/view/learning_sentence_round/widget/result_component.dart';
...
class ResultSentencePage extends StatelessWidget {
  ResultSentencePage({Key? key}) : super(key: key);
