...
class LearningSentenceRoundPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LearningSentenceRoundController>(builder: (_) {
      if (controller.roundSentence.sentence.toLowerCase() == controller.sentenceSpoken) {
          ...
          child: Scaffold(
              ...
              body: SingleChildScrollView(
                child: Column(
                  children: [
                    SizedBox(height: 20,),
                    YoutubePlayer(controller: controller.youtubeController,
                    ...
                    Stack(
                        children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height: 8,),
                                      Text('${controller.roundSentence.mean}',
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              InkWell(
                                                  onTap: () {
                                                    controller.speak(controller.roundSentence.sentence);
                                          ...
                                          SizedBox(width: 12,),
                                          Text('${controller.roundSentence.sentence}', style: TextStyle( fontSize: 20, fontWeight: FontWeight.w500),),
                                        ],),
                                      SizedBox(height: 32,),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Center(child: Text('${controller.sentenceSpoken}', style: TextStyle(fontSize: 18),)),
                                            decoration: BoxDecoration(
                                                border: Border(
                                                    bottom: BorderSide(
                                                        width: 1,
                                      ...
                                      SizedBox(height: 8,),
                                      Text('${controller.speechToText.isListening ? "listening..." : controller.speedEnable ? "Mic sẵn sàng" : "Mic không có sẵn"}'),
                                      if (controller.listIdSpell.contains(controller.roundSentence.id)) Row(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                          ...
                          Positioned(
                            ...
                            }, icon: Icon(Icons.replay,color: Color(0xffADADAD),)),
                          )
                        ]
                    )
                  ],
