                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      if (controller.typeQuestion == 'image')
                                        InkWell(
                                  ...
                                  SizedBox(height: 50,),
                                  Text('Mọi việc thế nào rồi?', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w300),),
                                  SizedBox(height: 50,),
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("How's it going?" , style: TextStyle(fontSize: 20, color: controller.indexAnswer == 1 ? Color(0xff29ABEA) : Color(0xff606061)),textAlign: TextAlign.center,),
                                      decoration: BoxDecoration(
