                ...
                return  Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Mẫu 1", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
                        SizedBox(height: 4,),
                        Row(
                          children: [
                            Text("Mẫu: "),
                            Text("Hôm nay thế nào rồi", style: TextStyle(color: Color(0xff342C27), fontWeight: FontWeight.w500),),
                          ],
                        ),
                        SizedBox(height: 4,),
                        Row(
