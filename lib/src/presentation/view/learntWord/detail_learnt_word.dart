...
import 'package:qlish/src/presentation/view/learntWord/widget/wordWidget.dart';


class LearntWordDetailPage extends StatelessWidget {
  LearntWordDetailPage({super.key});
  final controller = Get.find<LearntWordController>();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<LearntWordController>(
      builder: (controller) {
        return SafeArea(
            child: Scaffold(
              appBar: AppBar(
